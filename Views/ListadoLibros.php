...
<html>
  ...
  <div class="page-header">
    ...
    <h4>Puede ver la informacion y el estatus de todos sus Libros.</h4>
  </div>
           ...
           foreach ($ArrayLibros as $key => $value) {
             ?><tr>
               ...
               <?if($value['Estado'] == '0'){
                  ...
                  ?><td><span class="label label-danger">Con Deuda</span></td><?
               }?>
               </tr><?
           }
